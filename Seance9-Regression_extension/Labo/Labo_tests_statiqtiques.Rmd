...
t lu = 2.40 (avec la table de distribution de la loi de Student) 
...
t calculé en valeur absolu = 1.31 < t lu = 2.40, on **ne peut pas rejeter** l'hypothèse nulle. Autrement dit, il n'existe pas d'association significative entre le domaine de formation et la capacité de raisonnement critique.
