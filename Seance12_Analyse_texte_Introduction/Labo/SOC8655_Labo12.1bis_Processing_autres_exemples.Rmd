---
title: 'Labo 12.1bis: Analyse quantitative du texte'
subtitle: 'Processing'
...
Maintenant, on va créer le corpus avec ces documents. Chaque document va être considéré comme un document et les mots utilisés dans le texte comme les termes. 


## Exercice

Créer la matrice document-terme et le tidydata à partir de ces données.
