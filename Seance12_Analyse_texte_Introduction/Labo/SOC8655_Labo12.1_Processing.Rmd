---
title: 'Labo 12.1: Analyse quantitative du texte'
subtitle: 'processing'
...
```{r, out.width='70%'}
knitr::include_graphics("../Images/c11tidytextdata.png")
```
...
```{r, out.width='80%'}
knitr::include_graphics("../Images/c11prepocess.png")
```
...
```{r, out.width='70%'}
knitr::include_graphics("../Images/join_cheat.png")
```
...
L'ensemble de ses processus peut se faire assez aisément de la manière suivante en utilisant les pipes:
