...
knitr::include_graphics("..//Images/topic_modeling.png")
...
knitr::include_graphics("../Images/lda1.png")
...
>- Cette présentation est sublime https://www.youtube.com/watch?v=T05t-SqKArY
...
```{r, out.width='80%'}
knitr::include_graphics("../Images/lda3.png")
```
...
- Un modèle de sujets veut faire deux choses: 
...
knitr::include_graphics("../Images/gibbs2.png")
```
...
knitr::include_graphics("../Images/gibbs3.png")
```
...
knitr::include_graphics("../Images/gibbs4.png")
...
Cette vidéo est à regarder:

https://www.youtube.com/watch?v=BaM1uiCpj_E&t=0s
...
- où $\alpha$ et $\beta$ sont des facteurs de lissage qui empêchent un sujet d'avoir une probabilité nulle si un sujet n'utilise pas de mot ou si un document n'utilise pas de sujet. 
