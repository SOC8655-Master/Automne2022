...
knitr::include_graphics("/Users/visseho/OneDrive - UQAM/Cours/Images_cours/joke2.png")
...
> - Plus facile de corriger, de modifier et de répliquer des analyses 
> - Plus simple et naturel de créer un dossier permanent sur son travail, y compris les entrées et les sorties.
> - Interfaces graphiques vers des systèmes statistiques complexes sont **incomplètes** (nécessitant l'utilisation de commandes pour des analyses plus avancées ou non standard) ou/et **byzantines** (obligeant l'utilisateur à parcourir un labyrinthe complexe de menus, de boîtes de dialogue et de contrôles graphiques).
