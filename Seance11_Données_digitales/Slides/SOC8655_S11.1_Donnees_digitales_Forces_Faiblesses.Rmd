...
- les problèmes sur les données digitales tels que nous venons de le dire ne sont pas limités uniquement à ces données. Ils sont inhérents à tous les données.
...
- **Actualité**: dans quelle mesure les données sont-elles actualisées?
...
- Processus de décomposition d'une variable complexe en ces éleements constitutifs
