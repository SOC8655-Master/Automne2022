---
title: 'Séance 10.2: Données digitales'
...
- Le Xpath décrit la partie précise du code HTML où vivent les données que je veux. - J'identifie le "Xpath" en cliquant avec le bouton droit de la souris sur la section en surbrillance du volet des outils de développement qui affiche le code html:
...
section_wiki <- html_node(site_wiki, css = '')
?html_node()
