---
title: 'Séance 3.4: Visualisation avec ggplot: Extension'
...
ggplot(dhs_ipv) +
  geom_histogram(aes(x = beat_burnfood, fill = region)) +
  facet_wrap(~region)
...
```{r, out.width= '55%', message = FALSE, warning=FALSE, fig.align='center'}
...
```{r, out.width= '40%', message = FALSE, fig.align='center'}
ggplot(dhs_ipv) + 
...
```{r, out.width= '65%', message = FALSE, fig.align='center'}
