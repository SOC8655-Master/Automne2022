---
title: 'Séance 3.3: Visualisation avec ggplot'
...
knitr::include_graphics("../Images/graphique1.jpg")
```
...
knitr::include_graphics("../Images/graphique2.jpg")
```
...
knitr::include_graphics("../Images/ggplot_forme_generale.jpg")
```
...
homme_graphique <-
  ggplot(crsc96_small %>% filter(sexq == 1)) +
  geom_bar(aes(x = q2_new))
